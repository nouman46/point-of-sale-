        ...
        <div class="col-md-12">
          ...
          <div class="tab-content mt-3">
            ...
            <div class="tab-pane fade show active" id="users">
              ...
              <form
                id="addUserForm"
                action="${createLink(controller: 'setting', action: 'saveUser')}"
                method="POST"
                class="mb-4"
              >
                <div class="row">
              ...
              <form
                action="${createLink(controller: 'setting', action: 'assignRole')}"
                method="post"
              >
                <div class="row">
                  <div class="col-md-5">
                ...
                <tbody>
                  <g:each var="user" in="${users}">
                    <tr>
                      ...
                      <td>
                        <g:if
                          test="${!user.assignRole*.roleName.contains('ADMIN') && session.permissions?.roleManagement?.canEdit}"
                        >
                          <button
                            class="btn btn-warning btn-sm edit-user-btn"
                            data-id="${user.id}"
                            data-username="${user.username}"
                            data-roles="${user.assignRole*.id.join(',')}"
                          >
                            ✏️ Edit
                          </button>
                        </g:if>
                      ...
                      <td>
                        <g:if
                          test="${!user.assignRole*.roleName.contains('ADMIN') && session.permissions?.roleManagement?.canDelete}"
                        >
                          <button
            ...
            <div class="tab-pane fade" id="roles">
              ...
              <form
                id="addRoleForm"
                action="${createLink(controller: 'setting', action: 'saveRole')}"
                method="POST"
                class="mb-4"
              >
                <div class="row">
                    ...
                    <tr>
                      ...
                      <td>
                        <g:if test="${session.permissions?.roleManagement?.canEdit}">
                          <button
                            class="btn btn-warning btn-sm edit-role-btn"
            ...
            <div class="tab-pane fade" id="permissions">
              ...
              <form
                action="${createLink(controller: 'setting', action: 'assignPermission')}"
                method="post"
              >
                <div class="row">
                  <div class="col-md-6">
                  ...
                  <tbody>
                    <g:each var="page" in="${pages}">
                      <tr>
                        ...
                        <td>
                          <input type="checkbox" name="canView_${page}" />
                        </td>
                        <td>
                          <input type="checkbox" name="canEdit_${page}" />
                        </td>
                        <td>
                          <input type="checkbox" name="canDelete_${page}" />
                        </td>
                      </tr>
                    </g:each>
                  </tbody>
              ...
              <g:set
                ...
                value="${permissions.groupBy { it.assignRole.roleName }}"
              />
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form
                    id="editUserForm"
                    action="${createLink(controller: 'setting', action: 'editUser')}"
                    method="POST"
                  >
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form
                    id="editRoleForm"
                    action="${createLink(controller: 'setting', action: 'editRole')}"
                    method="POST"
                  >
          ...
          >
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form
                    action="${createLink(controller: 'setting', action: 'deleteRole')}"
                    method="post"
                  >
